...
(function($){
	...
	$.fn.carousel = function( method )
	{
		...
		function _initialize ()
		{
			...
			$(".carousel_content",carousel).one("load", function() {
				_posImages();
			});
		...
		function _posImages ()
		{
			...
			carousel__item.each(function(){
				...
				if($(".carousel_content", $(this)).length>0)
				{
					var _w = $(".carousel_content", $(this)).data('width');
					var _h = $(".carousel_content", $(this)).data('height');
					var _scale = (_width_item*100) / _w;
					var _wProp = (_w*_scale)/100;
					var _hProp = (_h*_scale)/100;

					$(".carousel_content", $(this)).css({width:_wProp - 1, height:_hProp});
			...
			var _itens_size = carousel__item.length;
